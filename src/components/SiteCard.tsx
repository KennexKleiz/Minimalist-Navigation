  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-4 relative z-10 w-full mb-3">
        {/* 左侧图标 */}
        <div className="relative h-14 w-14 shrink-0 overflow-hidden rounded-2xl bg-background/80 p-2.5 shadow-sm ring-1 ring-border/50 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3">
          {icon ? (
            isSvgCode ? (
              <div
